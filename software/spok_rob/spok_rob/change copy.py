...
def compute_pulse_position(joint_names, positions):
    ...
    for joint, pos in zip(joint_names, positions):
        if "shoulder" in joint:
            pulse_positions.append(pulse_sitting_down[joint]+pos*pulse_sitting_down[joint])
        else:
            pulse_positions.append(pos * pulse_sitting_down[joint] / angle_sitting_down[joint])
    return pulse_positions

# Load the data
input_file = '/home/tototime/ros2_spok_ws/src/S7_G7_Perrichet_Sibenaler/software/spok_rob/spok_rob/joint_trajectory_turn_around_data.csv'
output_file = '/home/tototime/ros2_spok_ws/src/S7_G7_Perrichet_Sibenaler/software/spok_rob/spok_rob/joint_trajectory_turn_around_data_modified.csv'
