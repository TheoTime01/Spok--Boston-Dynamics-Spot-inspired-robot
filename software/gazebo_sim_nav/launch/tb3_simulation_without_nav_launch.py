...
def generate_launch_description():
    ...
    #declare_map_yaml_file2_cmd = DeclareLaunchArgument(
    #    'map_yaml_file2', default_value=os.path.join(bringup_dir, 'maps', 'js_custom_map.yaml'),
    ...
    declare_world_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(gazebo_sim_nav_dir, 'worlds', '1st_floor.model'),
    ...
    #ld.add_action(declare_map_yaml_file2_cmd)
